...
h2. Skills Summary
* Active in *C#* development with *Windows Forms* and *OpenGL*.
...
* Experience with *Ruby, Perl, Bash, sed, JavaScript, HTML and CSS, Regular Expressions, Version Control, Unit Testing, Ant, Make, TEX.* Past experience in *C, C++, Assembly, Lisp,* and *application-specific languages.* Regularly use *Eclipse, Visual Studio* and *vim* as development environments.
